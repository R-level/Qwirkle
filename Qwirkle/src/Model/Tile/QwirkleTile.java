...
public class QwirkleTile {
    private int xPos; //x position of the Model.tile
    private int yPos; //z position of the Model.tile
    private QwirkleShape qwirkleShape; //Shape group of the Model.tile
    private QwirkleColour qwirkleColour; //Colour group of the Model.tile
