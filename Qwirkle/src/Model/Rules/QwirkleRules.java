...
import Model.Tile.QwirkleColour;
import Model.Tile.QwirkleShape;
...
public class QwirkleRules {
     ...
     *
     * @param x     x position of Model.tile being put
     * @param y     y position of Model.tile being put
     * @param tile  Model.tile being put
    ...
    public boolean isValidMove(int x, int y, QwirkleTile tile,
        ...
        // Step 2: Create lineEW & lineNS. Add Model.tile to each line.
        ...
        // Require that the first Model.tile be placed in the center of the board.
        if (empty) {
    ...
    /**
     * Method: getPoints
     * Gets how many points are being earned by placing a Model.tile.
    ...
    public int getPoints(ArrayList<QwirkleTile> playedTiles) {
        ...
        for (QwirkleTile tile : playedTiles) {
            //each played Model.tile will have an East to West line
            ...
            if (tile.lineNS.size() > 1) {
                for (QwirkleTile t : tile.lineNS) {
                    //check if Model.tile has been checked
         ...
         * Returns the legal moves for a given Model.tile as an ArrayList of Points.
         *
         * @param tile  The Model.tile for the move.
